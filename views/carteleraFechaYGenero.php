...
<?php
if (isset($_SESSION["proyeccionGeneroYFecha"])) {
    $cartelera = $_SESSION["proyeccionGeneroYFecha"];
    unset($_SESSION["proyeccionGeneroYFecha"]);
    if (!empty($cartelera)) {  ?>
    ...
    <?php } else {
            $msg = "No hay peliculas en cartelera pertenecientes a este género y/o fecha";
        }
    }
