...
<nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
    ...
    <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav text-uppercase ml-auto">
            ...
            <li class="nav-item">
                <a class="nav-link js-scroll-trigger" href="<?php echo (FRONT_ROOT) ?>/cine/index">Administrar cines</a>
            </li>
            <li class="nav-item">
                <a class="nav-link js-scroll-trigger" href="<?php echo (FRONT_ROOT) ?>/proyeccion/index">Proyecciones</a>
            </li>
            <li class="nav-item">
                <a class="nav-link js-scroll-trigger" href="<?php echo (FRONT_ROOT) ?>/entrada/index">Consultar ventas</a>
            </li>
            <li class="nav-item">
                <a class="nav-link js-scroll-trigger" href="<?php echo (FRONT_ROOT) ?>/usuario/index">Agregar administrador</a>
            </li>
            <li class="nav-item">
