<div class="container">
    ...
    <?php if (isset($_SESSION["movieDateGenre"])) { ?>
        <main class="p-5">
            <div class="container">

                <h2 class="mb-5">Listado de peliculas por fecha y categoria</h2>
                <table border="1" class="table" style="text-align:center;">
                    ...
                    <tbody>
                        <?php
                            $arrayMovies = $_SESSION["movieDateGenre"];
                            unset($_SESSION["movieDateGenre"]);
                            $i = 0;
